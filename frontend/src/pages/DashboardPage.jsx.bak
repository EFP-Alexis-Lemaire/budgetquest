  ...
  return (
    <div>
      ...
      <div className="relative h-3 bg-gray-800 rounded-full overflow-hidden">
        ...
        {/* Effet de lueur */}
        <div
          className="absolute top-0 h-full bg-gradient-to-r from-primary-400 to-purple-400 rounded-full opacity-40 blur-sm transition-all duration-500 ease-in-out"
          style={{ width: `${percent}%` }}
        />
      </div>
    </div>
            ...
            <div className="flex items-center gap-6 flex-wrap">
              ...
              {summary.savings_goal > 0 && (
                <div>
                  ...
                  <p className="text-xl font-bold text-yellow-400">{formatCurrency(summary.savings_goal)}</p>
                </div>
              )}
            </div>
          </div>
